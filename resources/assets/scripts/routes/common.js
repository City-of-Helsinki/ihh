  ...
  init() {
    ...
    function createAnchorlinks(navigationEl, anchorTargetEl) {
      ...
      if (headings && anchorNavigation) {
        ...
        const anchorlinksAtTop = document.querySelector(
        ...
        for (let i = 0; i < headings.length; i++) {
          ...
          const headingPosition = anchorNavigation.compareDocumentPosition(
            headings[i]
          );
      ...
      buttons.forEach((button) => {
        button.addEventListener("click", () => {
          ...
          setTimeout(() => {
            ...
            const firstItem =
              visibleFilteredAccordion[0].querySelector(".question-header");
