        ...
        <div class="row position-relative d-lg-flex flex-lg-nowrap my-4 mx-0 ihhce">
            ...
            <div class="contact-liftoff__info-box pt-3 pb-5 mt-3 mr-3 ml-0 col-lg-6 d-flex flex-column">
                ...
                <p class="info-box__description">
                    <?php if (get_sub_field("icon_visibility") == true) { echo $info_svg; };?><?php the_sub_field("info_box_description_5050"); ?>
                </p>
                <?php endif; ?>
                ...
                <a class="info-box__phone_number" aria-label="<?php pll_e('Call'); echo ' ' . $phone_arialabel; ?>"
                    href="tel:<?php echo $phone_trim; ?>"><?php the_sub_field("info_box_phone_number_5050"); ?></a>
                <?php endif; ?>
                <?php if( get_sub_field('info_box_email_5050') ): ?>
                <a class="info-box__email"
                    href="mailto:<?php the_sub_field("info_box_email_5050"); ?>"><?php the_sub_field("info_box_email_5050"); ?></a>
                <?php endif; ?>
                ...
                <a
                    href=<?php the_sub_field("info_box_external_link_5050"); ?>><?php the_sub_field("info_box_external_link_description_5050"); ?></a>
                <?php endif ?>
