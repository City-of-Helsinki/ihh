<?php
    ...
    $events_style = $events_background_color ? 'style="background-color:' . esc_attr($events_background_color) . ';"' : '';
?>
    ...
    <div class="section-events" <?php echo $events_style; ?>>
        <div class="container ihhce">
            ...
            <div class="load-more-wrapper">
                <a href="<?php echo esc_url($events_page_link); ?>" class="btn ihh-cta">
