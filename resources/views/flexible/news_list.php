...
$news_button_color = get_sub_field('news_button_color');
$news_page_link = get_permalink(
    function_exists('pll_get_post')
        ? pll_get_post(get_option('page_for_posts'))
        : get_option('page_for_posts'),
);
$news_style = $news_background_color
    ? 'style="background-color:' . esc_attr($news_background_color) . ';"'
    : '';
$button_style = $news_button_color
    ? 'style="background-color:' . esc_attr($news_button_color) . ';"'
    : '';
?>
