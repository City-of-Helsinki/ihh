...
<style>
.ihh-accordion .question .question-answer,
.ihh-accordion .question .question-header:hover {
    border-left-color: <?php the_sub_field('line_color'); ?> !important;
}

.ihh-accordion .question .question-header:not(.collapsed) {
    border-left-color: <?php the_sub_field('line_color'); ?> !important;
}
</style>
<?php endif; ?>
...
<div id="faqs_<?php echo $accordionName; ?>"
    ...
    $LIs .=
        '<li>
                <div class="question accordion" data-tags="' .
        rtrim($assignedTags, ',') .
        '">
        ...
        '">
                        <span>' .
        get_sub_field('accordion_heading') .
        '</span>
                    </button>
