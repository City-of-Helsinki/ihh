    ...
    <?php while (have_rows('faq_accordion')):
      ...
      <div class="question accordion checklist" style="background: <?php echo $bg_color; ?>;">
        <div class="question-box">
          <form>
            <input type="checkbox" id="accordion_content_checkbox_<?php echo $id_name; ?>" class="input-checkbox"
              name="accordion_content_checkbox_name_<?php echo $id_name; ?>" value="<?php the_sub_field('question'); ?>">
          </form>
          <span class="question-header collapsed" data-toggle="collapse"
            data-target="#accordion_content_<?php echo $id_name; ?>" aria-expanded="false"
            aria-controls="accordion_content_<?php echo $id_name; ?>" aria-owns="accordion_content_<?php echo $id_name; ?>">
                ...
                <?php while (have_rows('accordion_link_list')):
                  ...
                  <?php while (have_rows('accordion_links')):
                    ...
                    if (!empty($accordion_link)) { ?>
                      <span><a href="<?php echo $accordion_link['url']; ?>" target="<?php echo $accordion_link[
                           'target'
