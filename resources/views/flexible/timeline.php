...
<div class="timeline container">
    ...
    <?php if( $targetgroup_buttons ) : ?>
        <ul class="list-unstyled list-group list-group-horizontal mb-4" aria-labelledby="content_type">
            <li class="js-filter js-filter-service">
                ...
                <label for="service_targetgroup_2"><?php pll_e('EU'); ?></label></li>
    ...
    <<?php echo $listElementType; ?> class="<?php echo $cssClasses; ?>" <?php if($hasHeading){ echo 'aria-labelledby="timeline-heading"'; }?> >
        <?php while( have_rows('steps') ) : the_row(); $id = get_row_index(); ?>
            ...
            <li class="step image__<?php the_sub_field('image_alignment'); ?> service_targetgroup_<?php echo $targetgroup_acf; ?>" id="step_<?php echo $id; ?>">
