<?php
    ...
    while( have_rows('steps') ) : the_row(); $id = get_row_index();
...
<div class="timeline container">
    ...
    <<?php echo $listElementType; ?> class="<?php echo $cssClasses; ?>"
        <?php if($hasHeading){ echo 'aria-labelledby="timeline-heading"'; }?>>
        ...
        <li class="step image__<?php the_sub_field('image_alignment'); ?> service_targetgroup_<?php echo $targetgroup_acf; ?>"
            id="step_<?php echo $id; ?>">
            ...
            <div class="text-container <?php echo $bg_class; ?>" <?php echo $bg_style; ?>>
                <?php if( get_sub_field('heading') ) : ?><h3 class="heading"><?php the_sub_field('heading'); ?></h3>
                <?php endif ?>
