...
$banner_bg_color = isset($settings['banner_background_color'])
    ? sanitize_hex_color($settings['banner_background_color'])
    : '';
$banner_accent_color = isset($settings['banner_accent_color'])
    ? sanitize_hex_color($settings['banner_accent_color'])
    : '';
$banner_text_color = isset($settings['text_color'])
    ? sanitize_hex_color($settings['text_color'])
    : '';
?>

<div class="banner-container" style="color: <?php echo esc_attr(
    $banner_text_color,
  ...
  <div class="lift-100-wide lift-100-wide-drop lift-100-wide-- w-100 h-100 my-5" >
    <?php if (!$banner_img_only): ?>
      <div class="banner-shape" style="background-image: url('<?php echo esc_url(
          $banner_bg_image,
      ); ?>');"></div>
    ...
    <?php else: ?>
      <div class="banner-full" style="background-image: url('<?php echo esc_url(
          $banner_bg_image,
      ); ?>');"></div>
    <?php endif; ?>
  </div>
