        ...
        <a href="<?=get_permalink($event->ID)?>">
          <div class="event-list-item">
            <div class="event-date">
              <?= date("d.m.Y H:i", strtotime(get_field('start_time', $event->ID)));?> - <?= date("d.m.Y H:i", strtotime(get_field('end_time', $event->ID)));?>
            </div>
    ...
    <a href="<?=get_permalink($featured->ID)?>">
      <div class="event-featured">
        <div class="event-featured-content">
          <div class="event-date">
            <?= date("d.m.Y H:i", strtotime(get_field('start_time', $featured->ID)));?>
          </div>
          <div class="event-title">
            <?= $featured->post_title;?>
          </div>
