...
<section class="faqs container" id="faqs">
    ...
    <div class="question" id="question_{{$id}}">
        <button class="question-header collapsed" data-toggle="collapse" data-target="#answer_{{$id}}"
            aria-expanded="false" aria-controls="answer_{{$id}}" aria-owns="answer_{{$id}}">
            <span>{{the_sub_field('question')}}</span>
        </button>

        <div id="answer_{{$id}}" class="collapse question-answer" data-parent="#faqs">
